...
public class SNSClientTest {
    ...
    public void testCreate() throws IOException {
        ...
        try {
            client.publishMessage(getTopicARN(),
                                                 TEST_MSG_CONTENT);
        } catch(Exception e) {
    ...
    public void testSend() throws IOException {
        ...
        try {
            client.publishMessage(topicArn,
                                                 TEST_MSG_CONTENT);
        } catch(Exception e) {
    ...
    public void testReceive() throws IOException {
        ...
        sqsClient.allowTopic(url,
                             topicARN);
        client.subscribeToTopic(topicARN,
                                sqsClient.resolveQueueARN(url));
    ...
    public void testRawReceive() throws IOException {
        ...
        sqsClient.allowTopic(url,
                             topicARN);
        String subscriptionArn = client.subscribeToTopic(topicARN,
                                                         sqsClient.resolveQueueARN(url));
